...
export const TR = {
  ...
  cashflow: {
    ...
    monthlyReport: { th: "รายจ่ายรายเดือน", en: "Monthly expense report" } as Text,
    paymentSummary: { th: "ช่องทางการจ่าย", en: "Payment method summary" } as Text,
  ...
  assets: {
    ...
    growthVsPrevMonth: { th: "% เทียบเดือนก่อน", en: "% vs prev month" } as Text,
    growthVsPrevQuarter: { th: "% เทียบไตรมาสก่อน", en: "% vs prev quarter" } as Text,
    growthVsPrevHalf: { th: "% เทียบครึ่งปีก่อน", en: "% vs prev half-year" } as Text,
    growthVsPrevYear: { th: "% เทียบปีก่อน", en: "% vs prev year" } as Text,
