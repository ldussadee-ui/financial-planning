...
export const DEFAULT_EXPENSE_LABELS = ["ผ่อนบ้าน", "ผ่อนรถ", "ค่าเช่าที่พัก", "ค่าน้ำค่าไฟ", "ค่าอินเทอร์เน็ต", "เบี้ยประกัน", "ค่าอาหาร", "ค่าเดินทาง", "ช้อปปิ้ง", "ท่องเที่ยว/สังสรรค์", "ออมเงิน", "ลงทุน DCA"];
